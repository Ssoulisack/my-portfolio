...
function DockItem({
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      className={`relative inline-flex items-center mx-4 justify-center icon-nav rounded-full shadow-md ${className}`}
      tabIndex={0}
      role="button"
      aria-haspopup="true"
    >
...
export default function Dock({
  ...
  const maxHeight = useMemo(
    ...
    [dockHeight, magnification] // Now includes 'dockHeight'
  );
