...
export function ProfileHeader() {
  ...
  return <div className="flex flex-col md:flex-row items-center md:items-start gap-6 border-b pb-6">
    ...
    <div className="flex-1 text-center md:text-left">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
        ...
        <div className="flex gap-3 mt-4 md:mt-0 justify-center md:justify-start">
          ...
          <button onClick={() => downloadResume()} className="hover:bg-muted transition-delay-150 duration-700 ease-in-out hover:text-black flex items-center gap-1 px-4 py-2 bg-secondary text-secondary-foreground rounded-md">
            <Download size={18} />
            <span>Resume</span>
          </button>
        </div>
